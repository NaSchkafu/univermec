...
dnl Es wird nun die Variable $2_LDPATH statt LDPATH modifiziert
dnl LDPATH bleibt unmodifiziert, Sprache ist nun C++
dnl Ferner wird HAVE_$2 definiert
AC_DEFUN([AX_EXT_HAVE_LIB_SK],
[
old_ldflags=$LDFLAGS
old_libs=$LIBS
new_ldflags=${LDFLAGS}
...
$2[_LDFLAGS]="-L${dir} -l$2"
dnl new_libs="-l$2 ${new_libs}"
dnl new_ldflags="-L${dir} ${new_ldflags}"
ext_lib_found="yes"
fi
fi
done
