...
[n_inc=no
	case $with_n in
	     ''|yes) incdirs="/usr/local/include /usr/local/$1 /opt/$1 /usr/local/$1/include /opt/$1/include \
	     	     m4_if($4[]x,[x],[],[/usr/include/$4 /usr/local/include/$4 /usr/local/$1/$4 /opt/$1/$4 /usr/local/$1/$4/include /opt/$1/$4/include])";;		 
...
n_lib=no
AS_CASE([$with_n],[''|yes], 
	[libdirs="/usr/local/lib /usr/local/$1 /opt/$1 /usr/local/$1/lib /opt/$1/lib m4_if($4[]x,[x],[],[/usr/lib/$4 /usr/local/lib/$4 /usr/local/$1/$4 /opt/$1/$4 /usr/local/$1/$4/lib /opt/$1/$4/lib])"],
